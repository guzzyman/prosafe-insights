...
const FALLBACK: AskAnswer = {
  ...
  confidence: "Low",
  citations: [{ system: "ProSafe Intelligence", ref: "no matching evidence", age: "just now" }],
  evidence: [
...
export function askProSafe(question: string): AskAnswer {
